...
4. **📋 FAQ**: See [FAQ](docs/faq_database.md)
...
1. **📚 Read the [User Manual](docs/complete_user_manual.md)**
2. **⚙️ Configure your [brokers](docs/brokers.md)**
3. **🤖 Set up [AI integration](docs/ai_integration.md)**
4. **🛡️ Configure [risk management](docs/risk_management.md)**
